...
2. **Check for a `design-system.md`** (project root, `.project-docs/`, or `.claude/`) for conventions CSS can't express — typography hierarchy, component patterns, layout rules, branding tone etc.
